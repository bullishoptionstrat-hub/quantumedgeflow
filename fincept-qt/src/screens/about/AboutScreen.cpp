...
AboutScreen::AboutScreen(QWidget* parent) : QWidget(parent) {
    ...
    // ── Version Information ───────────────────────────────────────────────────
    {
        ...
        left->setSpacing(4);
        auto* name = new QLabel("Quantum Edge Flow");
        ...
        // Footer bar
        auto* foot = new QLabel("© 2024-2026 Quantum Edge Flow. All rights reserved.");
    ...
    // ── Trademarks ────────────────────────────────────────────────────────────
    {
        ...
        auto* desc = new QLabel("\"Quantum Edge Flow\" and associated logos are trademarks of "
                                "Quantum Edge Flow. Use of these marks requires explicit written permission.");
        desc->setStyleSheet(BODY());
        desc->setWordWrap(true);
        bvl->addWidget(desc);

        auto* perm =
            new QLabel("Permission is not granted to use Quantum Edge Flow trademarks in a way that suggests "
                       "affiliation with or endorsement by Quantum Edge Flow without prior written consent.");
