...
int main(int argc, char* argv[]) {
    ...
    SingleApplication app(argc, argv, /*allowSecondary=*/true, SingleApplication::Mode::User, 100,
                          profile_key.toUtf8());
    app.setApplicationName("QuantumEdgeFlow");
    app.setOrganizationName("Quantum Edge Flow");
...
#    define FINCEPT_VERSION_STRING "0.0.0-dev"
    ...
    LOG_INFO("App", "Quantum Edge Flow v4.0.2 starting...");
    ...
    if (setup_status.needs_setup) {
        ...
        setup_screen->setWindowTitle("Quantum Edge Flow — First-Time Setup");
